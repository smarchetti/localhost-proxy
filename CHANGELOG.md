...
- The daemon runs under Node when available: Bun 1.3's `node:http` drops writes to upgraded sockets, breaking WebSocket/HMR passthrough (covered by the smoke test's upgrade leg)
